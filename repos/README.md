...
jakob@odoo13_local_server:~$ cat .ssh/id_rsa.pub

ssh-rsa AAAAB3NzaC1yc2EAAAAD.......[reduced for space]..yqjlQqpECgyhNieLoskf+etAes= jakob@odoo13_local_server
...
yqjlQqpECgyhNieLoskf+etAes= jakob@odoo13_local_server" in the box!

* * * * 

To install all repos in the repos directory:

1) $ git clone -b 13.0 git@github.com:vertelab/odootools.git
