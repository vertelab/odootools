...
--- | --- 
 ...
 odoolangexport    | export po/pot file for a module, -m <module> -d <database> -l <language>. To export a pot-file exclude "-l" [Read more](https://raw.githubusercontent.com/vertelab/odootools/8.0/odoolangexport.pdf)
